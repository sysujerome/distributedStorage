...
type SyncReqest struct {
	...
	BeginLevel int32  `protobuf:"varint,3,opt,name=beginLevel,proto3" json:"beginLevel,omitempty"`
}

func (x *SyncReqest) Reset() {
	*x = SyncReqest{}
	if protoimpl.UnsafeEnabled {
...
func (x *SyncReqest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SyncReqest) ProtoMessage() {}

func (x *SyncReqest) ProtoReflect() protoreflect.Message {
	mi := &file_kvstore_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SyncReqest.ProtoReflect.Descriptor instead.
func (*SyncReqest) Descriptor() ([]byte, []int) {
	return file_kvstore_proto_rawDescGZIP(), []int{10}
}

func (x *SyncReqest) GetNext() string {
	if x != nil {
		return x.Next
	}
	return ""
...
func (x *SyncReqest) GetLevel() int32 {
	if x != nil {
		return x.Level
	}
	return 0
...
func (x *SyncReqest) GetBeginLevel() int32 {
	if x != nil {
		return x.BeginLevel
	}
	return 0
...
var file_kvstore_proto_rawDesc = []byte{
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x56,
	0x0a, 0x0a, 0x53, 0x79, 0x6e, 0x63, 0x52, 0x65, 0x71, 0x65, 0x73, 0x74, 0x12, 0x12, 0x0a, 0x04,
	...
	0x05, 0x6c, 0x65, 0x76, 0x65, 0x6c, 0x12, 0x1e, 0x0a, 0x0a, 0x62, 0x65, 0x67, 0x69, 0x6e, 0x4c,
	0x65, 0x76, 0x65, 0x6c, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0a, 0x62, 0x65, 0x67, 0x69,
	0x6e, 0x4c, 0x65, 0x76, 0x65, 0x6c, 0x22, 0x4d, 0x0a, 0x09, 0x53, 0x79, 0x6e, 0x63, 0x52, 0x65,
	0x70, 0x6c, 0x79, 0x12, 0x10, 0x0a, 0x03, 0x65, 0x72, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x03, 0x65, 0x72, 0x72, 0x12, 0x16, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18,
	...
	0x65, 0x73, 0x75, 0x6c, 0x74, 0x32, 0xbe, 0x02, 0x0a, 0x07, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67,
	...
	0x35, 0x0a, 0x08, 0x53, 0x79, 0x6e, 0x63, 0x43, 0x6f, 0x6e, 0x66, 0x12, 0x13, 0x2e, 0x6b, 0x76,
	0x73, 0x74, 0x6f, 0x72, 0x65, 0x2e, 0x53, 0x79, 0x6e, 0x63, 0x52, 0x65, 0x71, 0x65, 0x73, 0x74,
	0x1a, 0x12, 0x2e, 0x6b, 0x76, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x2e, 0x53, 0x79, 0x6e, 0x63, 0x52,
...
var file_kvstore_proto_goTypes = []interface{}{
	...
	(*SyncReqest)(nil),   // 10: kvstore.SyncReqest
...
var file_kvstore_proto_depIdxs = []int32{
	...
	10, // 5: kvstore.Storage.SyncConf:input_type -> kvstore.SyncReqest
